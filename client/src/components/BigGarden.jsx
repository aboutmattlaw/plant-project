...
function BigGarden({setCurrentUser, currentUser, setCurrentUserGardens, currentUserGardens}) {
    ...
    let nonStateCommunityPlantList = communityPlants
    ...
    function onSearch() {
        nonStateCommunityPlantList = plantList.filter(plant => {
    ...
    return(  
        <>
            ...
            <Routes> 
                ...
                <Route path="/communityplants" element={<Plant plantList={nonStateCommunityPlantList} currentUser={currentUser} setSearchBar={setSearchBar} searchBar={searchBar} onSearch={onSearch} />} />
            </Routes>
        </>
    )
}
